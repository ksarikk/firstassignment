    ...
    <form action="" id="showdetails" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
      ...
      <br>
       ...
       <div class="container">
        <div class="row">
          ...
          <div class="col-4 titlebox"><input name="name" id="name" autocomplete="off"></input></div>
          <span><?php echo $nameErr; ?></span>
          
           <div class="col-2 titleclr">Social Security#</div>
          <div class="col-4 titlebox" ><input name="social" autocomplete="off"></input></div>

          <div class="w-100 d-none d-md-block"></div>

          <div class="col-2 titleclr">Address</div>
          <div class="col-4 titlebox" ><input name="address" autocomplete="off"></input></div>
          
          <div class="col-2 titleclr">Birth Date</div>
          <div class="col-4 titlebox"><input name="birthdate1" type="date" style="width:256px"></input></div>



          <div class="col-2 titleclr">City</div>
          <div class="col-4 titlebox"><input name="city" autocomplete="off"></input></div>
          <div class="col-2 titleclr">Parent/Guardian</div>
          <div class="col-4 titlebox"><input name="parent" autocomplete="off"></input></div>

          <div class="col-2 titleclr">State</div>
          <div class="col-4 titlebox"><input name="state" autocomplete="off"></input></div>
          <div class="col-2 titleclr">Referred by</div>
          <div class="col-4 titlebox"><input name="referredby" autocomplete="off"></input></div>

          <div class="w-100 d-none d-md-block"></div>

          <div class="col-2 titleclr">Zip</div>
          <div class="col-4 titlebox"><input name="zip" type="number" placeholder="12345..." autocomplete="off"></input></div>
          <div class="col-2 titleclr">Occupation</div>
          <div class="col-4 titlebox"><input name="occupation" autocomplete="off"></input></div>
          ...
          <div class="col-4 titlebox"><input name="cellphone1" type="tel" placeholder="9999999999" autocomplete="off"></input></div>
          <div class="col-2 titleclr">Cell Phone</div>
          <div class="col-4 titlebox"><input name="cellphone2" type="tel" placeholder="9999999999" autocomplete="off"></input></div>

          <div class="w-100 d-none d-md-block"></div>

          <div class="col-2 titleclr">Home Phone</div>
          <div class="col-4 titlebox"><input name="homephone" type="tel" placeholder="9999999999" autocomplete="off"></input></div>

          <div class="col-2 titleclr">Employer's Name</div>
          <div class="col-4 titlebox"><input name="employername" autocomplete="off"></input></div>

          <div class="w-100 d-none d-md-block"></div>

          <div class="col-2 titleclr">Mobile Phone</div>
          <div class="col-4 titlebox"><input name="mobilephone" type="tel" placeholder="9999999999" autocomplete="off"></input></div>
          <div class="col-2 titleclr">Employer's Email</div>
          <div class="col-4 titlebox"><input name="employeremail" type="email" placeholder="....@gmail.com" autocomplete="off"></input></div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-8 titlebox"><input name="othercondition" autocomplete="off"></input></div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-8 titlebox"><input name="medications" autocomplete="off"></input></div>
        ...
        <div class="row">
          ...
          <div class="col-8 titlebox"><input name="familydoctor" autocomplete="off"></input></div>
        ...
        <div class="row">
          ...
          <div class="col-8 titlebox"><input name="allergies" autocomplete="off"></input></div>
        ...
        <div class="row">
          ...
          <div class="col-8 titlebox"><input name="lastexam" type="date" autocomplete="off" style="width:256px"></input></div>
        ...
        <div class="row">
          ...
          <div class="col-8 titlebox"><input name="eyedisorder" autocomplete="off"></input></div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-4 titlebox"><input name="insurancename1" autocomplete="off"></input></div>
          <div class="col-2 titleclr">Insurance Name</div>
          <div class="col-4 titlebox"><input name="insurancename2" autocomplete="off"></input></div>
        </div>
        <div class="row">

          <div class="col-2 titleclr">Employer</div>
          <div class="col-4 titlebox"><input name="employer1" autocomplete="off"></input></div>
          <div class="col-2 titleclr">Employer</div>
          <div class="col-4 titlebox"><input name="employer2" autocomplete="off"></input></div>
        ...
        <div class="row">
          ...
          <div class="col-4 titlebox"><input name="insuredname1" autocomplete="off"></input></div>
          <div class="col-2 titleclr">Insured's Name</div>
          <div class="col-4 titlebox"><input name="insuredname2" autocomplete="off"></input></div>

        </div>
        <div class="row">

          <div class="col-2 titleclr">Birth Date</div>
          <div class="col-4 titlebox"><input type="date" name="birthdate11" style="width:256px"></input></div>

          <div class="col-2 titleclr">Birth Date</div>
          <div class="col-4 titlebox"><input type="date" name="birthdate22" style="width:256px" ></input></div>
        ...
        <div class="row">
          ...
          <div class="col-4 titlebox"><input name="insuredss1" autocomplete="off"></input></div>
          <div class="col-2 titleclr">Insured's SS#</div>
          <div class="col-4 titlebox"><input name="insuredss2" autocomplete="off" ></input></div>
        </div>
      </div>
