<?php
   ...
   if(isset($_POST['submit'])){
      ...
      if(move_uploaded_file($filefolder,$file_tmp)){
         echo "file uploded  successful";
      }else{
         echo "file note uploaded";
      }
   }
...
<h2>Patient Details are:</h2>
<br><br>
<h4>Hello &nbsp;<?php echo $_POST["name"]; ?>!!<br></h4>
<h4>Social Security- &nbsp;<?php echo $_POST["social"]; ?><br></h4>
<h4>Address- &nbsp; <?php echo $_POST["address"]; ?><br></h4>
<h4>Birth Date- &nbsp;<?php echo $_POST["birthdate"]; ?><br></h4>


<h4>City- &nbsp;<?php echo $_POST["city"]; ?><br></h4>
<h4>Parent/Guardian- &nbsp; <?php echo $_POST["parent"]; ?><br></h4>
<h4>State- &nbsp;<?php echo $_POST["state"]; ?><br></h4>
<h4>Referred By- <?php echo $_POST["referredby"]; ?></h4>

<h4>Zip- &nbsp;<?php echo $_POST["zip"]; ?><br></h4>
<h4>Occupation- &nbsp; <?php echo $_POST["occupation"]; ?><br></h4>
<h4>Cellphone- &nbsp;<?php echo $_POST["cellphone"]; ?><br></h4>
<h4>Cellphone- <?php echo $_POST["cellphonee"]; ?><br></h4>

<h4>Home Phone- &nbsp;<?php echo $_POST["homephone"]; ?><br></h4>
<h4>Employer Name- &nbsp; <?php echo $_POST["employername"]; ?><br></h4>
<h4>Mobile Phone- &nbsp;<?php echo $_POST["mobilephone"]; ?><br></h4>
<h4>Email- <?php echo $_POST["employeremail"]; ?><br></h4>


<h4>Other Condition(s)- &nbsp;<?php echo $_POST["othercondition"]; ?><br></h4>
<h4>Medications you are presently taking- &nbsp; <?php echo $_POST["medications"]; ?><br></h4>
<h4>Name of Family Doctor- &nbsp;<?php echo $_POST["familydoctor"]; ?><br></h4>


<h4>List any allergies to medications- &nbsp;<?php echo $_POST["allergies"]; ?><br></h4>
<h4>Date of Last Exam- &nbsp; <?php echo $_POST["lastexam"]; ?><br></h4>

<h4>Family History of eye disorders- <?php echo $_POST["eyedisorder"]; ?><br></h4>

<h4>Insurance Name- &nbsp;<?php echo $_POST["insurancename"]; ?><br></h4>
<h4>Insurance Name- &nbsp;<?php echo $_POST["insurancenamee"]; ?><br></h4>
<h4>Employer- &nbsp; <?php echo $_POST["employer"]; ?><br></h4>
<h4>Employer- &nbsp; <?php echo $_POST["employer"]; ?><br></h4>
<h4>Insured's Name- &nbsp;<?php echo $_POST["insuredname"]; ?><br></h4>
<h4>Insured's Name- &nbsp;<?php echo $_POST["insurednamee"]; ?><br></h4>
<h4>Birth Date- <?php echo $_POST["birthdatee"]; ?><br></h4>
<h4>Birth Date- <?php echo $_POST["birthdateee"]; ?><br></h4>
<h4>Insured's SS- &nbsp;<?php echo $_POST["insuredss"]; ?><br></h4>
<h4>Insured's SS- &nbsp;<?php echo $_POST["insuredsss"]; ?><br></h4>
